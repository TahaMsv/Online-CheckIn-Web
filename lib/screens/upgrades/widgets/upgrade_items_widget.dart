                ...
                Text(value.description, overflow: TextOverflow.clip, style:isTabletMode?MyTextTheme.darkGrey25W300: MyTextTheme.boldDarkGray12),
                  ...
                  [
                    upgradesState.entertainmentsNumberOfSelected[index] == 0
                      ...
                      isPrinter: isPrinter,
                      color: color,
                      numberOfSelected: isPrinter ? upgradesState.entertainmentsNumberOfSelected[index] : upgradesState.winesNumberOfSelected[index], isTabletMode: isTabletMode,
                    )
                  ],
            ),
          ),
...
class ChangeNumOfSelected extends StatelessWidget {
  const ChangeNumOfSelected({
    ...
    required this.isPrinter,
    required this.color,
    required this.numberOfSelected, required this.isTabletMode,
  }) : super(key: key);
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children:  <Widget>[
                    Icon(Icons.remove, color: MyColors.white, size:isTabletMode?22: 18), // icon// text
                  ],
                ),
              ),
            ),
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children:  <Widget>[
                    Icon(Icons.add, color: MyColors.white, size:isTabletMode?22: 18), // icon// text
                  ],
                ),
              ),
            ),
