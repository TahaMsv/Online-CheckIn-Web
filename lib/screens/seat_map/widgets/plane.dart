                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Center(
                            child: Text("${seatMapState.travelerToSelectIndexTablet + 1}/${stepsState.travelers.length}", style:deviceType.isTablet? MyTextTheme.black25W700:MyTextTheme.black17W700),
                          ),
                          // color: Colors.black,
                        ),
                        SizedBox(
