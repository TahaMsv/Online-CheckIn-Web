...
class ReceiptStepTabletView extends StatelessWidget {
  final ReceiptStepController myReceiptStepController;

  ReceiptStepTabletView(MainModel model) : myReceiptStepController = Get.put(ReceiptStepController(model));
      ...
      body: Obx(
          ...
          child: Column(
            children: [
              ...
              Text(
                "You can see your check-in below, print it or download it or send it to your mobile".tr,
